...
if [ $KUBESPRAYUSEVIRTUALENV -eq 1 ]; then
    ...
    $KUBESPRAY_VIRTUALENV/bin/$PIP install -r kubespray/requirements.txt
if [ ! -e "$KUBESPRAY_VIRTUALENV/bin/ansible-playbook" ]; then
    $KUBESPRAY_VIRTUALENV/bin/$PIP install ansible
fi
else
...
for node in $NODES ; do
    ...
    echo "AHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHhhhh"
...
tries=60
while [ $tries -gt 0 ]; do
    microk8s kubectl wait pod -n kube-system --for=condition=Ready --all
    if [ $? -eq 0 ]; then
	break
    else
	tries=`expr $tries - 1`
